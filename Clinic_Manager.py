...
backup_folder = os.path.expanduser(r'C:\Backup')
...
def quit_app():
    ...
    try:
        ...
        destination_file = os.path.join(backup_folder, os.path.basename(db_file))
        old_file = os.path.join(backup_folder, file_name + "_old" + file_ext)
