...
def retrieve_file():
    ...
    ret_table=ttk.Treeview(ret_frame, yscrollcommand=ret_scroll.set)
    ...
    ret_table.column("#0",width=40,minwidth=30)
    ret_table.column("File Number",width=50,minwidth=25)
    ret_table.column("Name",width=150,minwidth=50)
    ret_table.column("Description",width=250,minwidth=25)
    ret_table.column("Date",width=80,minwidth=25)
